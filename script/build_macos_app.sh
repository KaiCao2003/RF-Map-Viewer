...
APP_VERSION="${RF_MAP_VIEWER_VERSION:-2.1.0}"
APP_BUILD="${RF_MAP_VIEWER_BUILD:-20100}"
...
ARCHIVE_PATH="$DIST_DIR/$ARTIFACT_STEM-macos-arm64.zip"
...
[[ "$BUNDLED_JSON_COUNT" == "$SOURCE_JSON_COUNT" ]] || fail "Bundled JSON resource count does not match source"
