...
`.local` name), plus `198.51.100.0/24`, `192.0.2.0/24`, and
`203.0.113.0/24`; all other forwarded clients receive 403. The service binds
...
(`fe80::/10`), plus `198.51.100.0/24`, `192.0.2.0/24`, and
`203.0.113.0/24`, and rejects other clients. The Web app accepts small JSON
