...
def VisStimConfig():
    ...
    resfile_folder_path = "/data/rfmapping/"
    recording_date = "260603/"

    data_folder = "/data/rfmapping/recordings/example-session/"
    stimulus_folder = "/data/rfmapping/recordings/example-session/"
    ...
    visual_stimuli_config.outputMatFilesFolder = "/srv/rfmapping-storage/MatFiles"

    visual_stimuli_config.gratingSpreadsheetFile = resfile_folder_path + "rfmapping/MatlabApps/360/Info_Grating.xlsx"
    visual_stimuli_config.rfSpreadsheetFile = resfile_folder_path + "rfmapping/MatlabApps/360/Info_RFmapping.xlsx"
    ...
    visual_stimuli_config.fmaToolboxRoot = resfile_folder_path + "rfmapping/MatlabApps/buzcode/externalPackages/FMAToolbox"
