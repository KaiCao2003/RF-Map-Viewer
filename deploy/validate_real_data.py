...
RF_ROOT = Path("/data/rfmapping")

M17_DAY = RF_ROOT / "rfmapping/#Recording/m17/260729"
...
M15_DAY = RF_ROOT / "rfmapping/#Recording/m15/260630"
...
M14_DATA = RF_ROOT / "rfmapping/#Recording/m14/260615/260615_3/data"
M14_RF = M14_DATA / (
...
def load_supported_tuning(path: Path) -> Any:
    ...
    package_root = APP_ROOT / "rfmapping_web"
...
def validate_frontend_assets(*, require_bundle: bool) -> None:
    ...
    if not bundle_files:
        ...
        note("PASS bundle check deferred to release gate (web/dist is not built yet)")
        return
