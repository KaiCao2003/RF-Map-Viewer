...
- Start with a nonmodal welcome window offering Open and native macOS recent documents, with the app icon and separate filename/path typography. The file chooser opens only on request.
