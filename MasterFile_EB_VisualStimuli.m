...
cfg.outputMatFilesFolder = 'R:\rfmapping\MatlabApps\MatFiles';

cfg.gratingSpreadsheetFile = [resfile_folder_path, 'rfmapping\MatlabApps\360\Info_Grating.xlsx'];
cfg.rfSpreadsheetFile = [resfile_folder_path, 'rfmapping\MatlabApps\360\Info_RFmapping.xlsx'];
...
cfg.fmaToolboxRoot = [resfile_folder_path, 'rfmapping\MatlabApps\buzcode\externalPackages\FMAToolbox'];
